...
public interface GymMapper {
    ...
    @Select("select prov,city,Id,CH_Name name,phone,email,coordinate,tip,addr,dtPreSale,dtOpen from TLG_Gym where status=1 and (City=#{City} or #{City}=-1) order by 2")
