...
public class testCtrl  {
    ...
    private Object getProvince(@RequestParam(value="callback",required = false)String callback){
    ...
    private Object getGym(@PathVariable("provinceId") Integer provinceId){
        //  PageHelper.startPage(3,2);
    ...
    private Object getCity(@PathVariable("cityId") Integer cityId){
        //  PageHelper.startPage(3,2);
